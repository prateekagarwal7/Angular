...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet, LoginComponent, Profile, CounterComponent, FormsModule, TodoComponent, HomeComponent, RouterOutlet, HeaderComponent, DynamicRouteComponent, ReactiveFormComponent],//importing the login component
